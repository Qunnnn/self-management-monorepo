...
class DefaultApi {
  ...
  Future<Response<AuthResponse>> authLoginPost({ 
...
_responseData = rawData == null ? null : deserialize<AuthResponse, AuthResponse>(rawData, 'AuthResponse', growable: true);
  ...
  Future<Response<User>> authRegisterPost({ 
    ...
    try {
      _bodyData = jsonEncode(createUserRequest);
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> healthGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Task>>> tasksGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<List<Task>, Task>(rawData, 'List<Task>', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Task>> tasksIdCompletePatch({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/tasks/{id}/complete'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Task, Task>(rawData, 'Task', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Task] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Task>> tasksIdCompletePost({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Task, Task>(rawData, 'Task', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> tasksIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/tasks/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Task] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Task>> tasksIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Task, Task>(rawData, 'Task', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Task] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Task>> tasksPost({ 
    ...
    try {
      _bodyData = jsonEncode(createTaskRequest);
...
_responseData = rawData == null ? null : deserialize<Task, Task>(rawData, 'Task', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<User>>> usersGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> usersIdPut({ 
    required String id,
    required ModifyUserRequest modifyUserRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(modifyUserRequest);
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [List<Task>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Task>>> usersIdTasksGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{id}/tasks'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<List<Task>, Task>(rawData, 'List<Task>', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserStats>> usersStatsGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<UserStats, UserStats>(rawData, 'UserStats', growable: true);
